      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-8">
          {questions.map((question, index) => (
            <Fragment key={index}>
              <p className="bg-secondary/60 text-foreground/80 ml-auto max-w-[60%] rounded-xl px-3 py-2 text-sm shadow">
                {question}
              </p>
              {responses[index] && (
                <p
        ...
        <div
          className="mt-auto flex cursor-text flex-col rounded-lg border border-border/60 bg-secondary/50 p-4"
        ...
        >
          ...
          />
          <Button className="ml-auto size-8 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/40 hover:bg-primary/90">
